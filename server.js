...
app.use((req,res, next) => {
    ...
    switch(true)
    {
        ...
        case ['/api/user/login', '/api/user/login/microsoft', '/api/user/auth/microsoft', '/api/session/check', '/api/session/logout', '/api/user/register', '/api/user/canResetPassword', '/api/user/resetPassword'].indexOf(url) >= 0 :
            next()
            break;
